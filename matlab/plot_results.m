subplot(2, 2, 1);
plot( ...
  results.params(:,2)+.02*rand(640,1)-0.01, results.all(:,1) +.8*rand(640,1)-0.4, 'r.', ...
  results.params(:,2)+.02*rand(640,1)-0.01, results.pct(:,1) +.8*rand(640,1)-0.4, 'b.', ...
  results.params(:,2)+.02*rand(640,1)-0.01, results.sigma(:,1)+.8*rand(640,1)-0.4, 'g.', ...
  results.params(:,2)+.02*rand(640,1)-0.01, results.x84(:,1)+.8*rand(640,1)-0.4, 'm.', ...
  results.params(:,2)+.02*rand(640,1)-0.01, results.dynamic(:,1)+.8*rand(640,1)-0.4, 'c.', ...
  results.params(:,2)+.02*rand(640,1)-0.01, results.hmrf(:,2)+.8*rand(640,1)-0.4, 'ko');
title('Iterations');
legend('All', 'Percent', 'Sigma', 'X84', 'Dynamic', 'HMRF');

subplot(2, 2, 2);
plot( ...
  results.params(:,2)+.02*rand(640,1)-0.01, results.all(:,2), 'r.', ...
  results.params(:,2)+.02*rand(640,1)-0.01, results.pct(:,2), 'b.', ...
  results.params(:,2)+.02*rand(640,1)-0.01, results.sigma(:,2), 'g.', ...
  results.params(:,2)+.02*rand(640,1)-0.01, results.x84(:,2), 'm.', ...
  results.params(:,2)+.02*rand(640,1)-0.01, results.dynamic(:,2), 'c.', ...
  results.params(:,2)+.02*rand(640,1)-0.01, results.hmrf(:,3), 'ko');
title('Elapsed time');

subplot(2, 2, 3);
plot( ...
  results.params(:,2)+.02*rand(640,1)-0.01, results.all(:,3), 'r.', ...
  results.params(:,2)+.02*rand(640,1)-0.01, results.pct(:,3), 'b.', ...
  results.params(:,2)+.02*rand(640,1)-0.01, results.sigma(:,3), 'g.', ...
  results.params(:,2)+.02*rand(640,1)-0.01, results.x84(:,3), 'm.', ...
  results.params(:,2)+.02*rand(640,1)-0.01, results.dynamic(:,3), 'c.', ...
  results.params(:,2)+.02*rand(640,1)-0.01, results.hmrf(:,4), 'ko');
title('Error, translation');

subplot(2, 2, 4);
plot( ...
  results.params(:,2)+.02*rand(640,1)-0.01, results.all(:,4), 'r.', ...
  results.params(:,2)+.02*rand(640,1)-0.01, results.pct(:,4), 'b.', ...
  results.params(:,2)+.02*rand(640,1)-0.01, results.sigma(:,4), 'g.', ...
  results.params(:,2)+.02*rand(640,1)-0.01, results.x84(:,4), 'm.', ...
  results.params(:,2)+.02*rand(640,1)-0.01, results.dynamic(:,4), 'c.', ...
  results.params(:,2)+.02*rand(640,1)-0.01, results.hmrf(:,5), 'ko');
